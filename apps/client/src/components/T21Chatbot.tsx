...
export function T21Chatbot() {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-6 right-6 w-96 h-[600px] bg-[var(--bg-primary)] rounded-2xl shadow-2xl flex flex-col z-50 border border-[var(--border)]">
          {/* Header */}
          <div className="flex items-center justify-between p-4 border-b border-[var(--border)] bg-gradient-to-r from-[var(--matcha)] to-[var(--matcha-dark)]">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            {showEmailPrompt && !hasProvidedEmail && (
              <div className="flex justify-start">
                <div className="max-w-[80%] rounded-2xl px-4 py-3 bg-[var(--matcha)]/10 border border-[var(--matcha)]">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-lg border border-[var(--border)] bg-[var(--bg-primary)] text-sm focus:outline-none focus:ring-2 focus:ring-[var(--matcha)]"
                    onKeyPress={(e) => {
                      if (e.key === 'Enter') {
            ...
            {isLoading && (
              <div className="flex justify-start">
                <div className="bg-[var(--bg-elevated)] rounded-2xl px-4 py-2">
          ...
          <div className="p-4 border-t border-[var(--border)]">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 rounded-full border border-[var(--border)] bg-[var(--bg-elevated)] text-[var(--text-primary)] placeholder:text-[var(--text-secondary)] focus:outline-none focus:ring-2 focus:ring-[var(--matcha)]"
                disabled={isLoading}
              />
              <button
